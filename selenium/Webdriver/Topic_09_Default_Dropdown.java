...
public class Topic_09_Default_Dropdown {
	...
	public void beforeClass() {
		...
		firstName = "Sun";
		lastName = "beos";
		emailAddress = "sunbeo" + getRandomNumber() + "@mailinator.com";
		companyName = "Sun CD Ltd";
		password = "Hahaha@123";
		day = "23";
		month = "March";
		year = "2022";
	...
	public void TC_01_Register_New_Account() {
		...
		Assert.assertFalse(new Select(driver.findElement(By.name("DateOfBirthDay"))).isMultiple()); //Verify xem dropdown đó là Multiple hay Single
