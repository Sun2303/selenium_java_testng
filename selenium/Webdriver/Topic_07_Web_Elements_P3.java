...
public class Topic_07_Web_Elements_P3 {
	WebDriver driver;
	Random rand;
	...
	public void beforeClass() {
		...
		emailAddress = "automation" + rand.nextInt(9999) + "@info.com";
		firstName = "Sun";
		lastName = "Lee";
	...
	public void TC_02_Login_with_Invalid_Email() {
		...
		driver.findElement(By.xpath("//div[@class='footer']//a[text()='My Account']")).click();
		sleepInSecond(2);
		driver.findElement(By.id("email")).sendKeys("sunchanbedu@123123");
	...
	public void TC_03_Login_with_Password_less_than_6chars() {
		...
		driver.findElement(By.xpath("//div[@class='footer']//a[text()='My Account']")).click();
		sleepInSecond(2);
		driver.findElement(By.id("email")).sendKeys("sunchanbedu@gmail.com");
	...
	public void TC_04_Login_with_Incorrect_Email(){
		...
		driver.findElement(By.id("pass")).sendKeys("abc123345");
		driver.findElement(By.id("send2")).click();
		sleepInSecond(2);
